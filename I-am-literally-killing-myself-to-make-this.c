...
task main(){
    ...
    while (true){
        ...
        Lstart_vel, Lprev_target = goToTarget(left_target,  leftMotor,  Lstart_vel, Lprev_target)
		Rstart_vel, Rprev_target = goToTarget(right_target, rightMotor, Rstart_vel, Rprev_target)
